...
To see if using the original event points will address our concern, we repeat the code chunk below to recreate the interactive map.
...
## E.4 All Years, All Accidents, Initial Analysis
...
Next, we can create an interactive map to show the computed KDEs visually using **tmap** package in the code chunk below.
